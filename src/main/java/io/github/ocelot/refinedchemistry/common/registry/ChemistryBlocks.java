...
public class ChemistryBlocks
{
    ...
    public static final DeferredRegister<TileEntityType<?>> TILE_ENTITIES = DeferredRegister.create(ForgeRegistries.TILE_ENTITIES, RefinedChemistry.MOD_ID);
    ...
    private static <T extends Block> RegistryObject<T> register(String name, Supplier<T> block, Function<RegistryObject<T>, Item> item)
    {
        ...
        ChemistryItems.ITEMS.register(name, () -> item.apply(object));
        return object;
    }
}